...
const IdeaSidebar: React.FC = () => {
  ...
  return (
    <aside className={`transition-all duration-300 bg-brand-green-50/50 border-l border-brand-green-200 ${isCollapsed ? 'w-12' : 'w-72'}`}>
          ...
          <div className="flex-1 overflow-y-auto">
            {isLoading ? (
             ...
             <div className="mt-4 text-center">
                <button onClick={fetchIdeas} disabled={isLoading} className="flex items-center justify-center gap-2 w-full px-4 py-2 text-sm font-semibold text-white bg-brand-green-600 rounded-lg hover:bg-brand-green-700 disabled:bg-brand-green-400 transition-colors">
                    <RefreshIcon/>
