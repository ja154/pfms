    ...
    const transactionsForSelectedSupplier = useMemo(() => {
     ...
     const filteredTransactions = useMemo(() => {
        ...
        return baseTransactions.filter(t => {
            const transactionDate = new Date(`${t.date}T00:00:00`); // Parse as local time
                ...
                <div className="flex flex-wrap gap-4 justify-between items-center mb-4">
                    ...
                    <div className="relative w-full max-w-xs">
                        <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                            <svg className="h-5 w-5 text-slate-400" xmlns="http://www.w.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
